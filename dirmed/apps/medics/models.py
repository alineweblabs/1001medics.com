...
class Schedule(models.Model):
	...
	day          = models.CharField(max_length=5,choices=MembershipType,null=True,blank=True,verbose_name=u'Día')
...
class Profile(models.Model):
	...
	phone           = models.IntegerField(null=True,blank=True,default=0,verbose_name=u'Teléfono')
	...
	#schedule       = models.ForeignKey(Schedule,null=True,blank=True,verbose_name=u'Horarios')
